  ...
  return (
    <div>
      ...
      <div className='px-32 py-2' id="board">
        <div className='bg-blue-50 flex h-100 gap-6'>
          <div id="pending" className='bg-amber-50 w-150 p-2 rounded'>
            <div className='p-4 bg-orange-400 text-lg text-white font-medium rounded'>Pendente</div>
            <div draggable className='p-6 m-6 bg-orange-200 cursor-move rounded shadow'>te</div>
          </div>
          <div id="progress" className='bg-blue-50 w-150 p-2 rounded'>
            <div className='p-4 bg-blue-400 text-lg text-white font-medium rounded'>Em Andamento</div>
            <div draggable className='p-6 m-6 bg-blue-200 cursor-move rounded shadow'>a</div>
          </div>
          <div id="done" className='bg-green-50 w-150 p-2 rounded'>
            <div className='p-4 bg-green-400 text-lg text-white font-medium rounded'>Concluído</div>
            <div draggable className='p-6 m-6 bg-green-200 cursor-move rounded shadow'>b</div>
          </div>
        </div>
      </div>
    </div>
